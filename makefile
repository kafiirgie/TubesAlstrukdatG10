...
all: 
	$(CC) main.c View/Menu/Menu.c View/Game/Game.c ADT/Player/Player.c ADT/Configuration/Configuration.c ADT/MesinKarKat/mesin_kar.c ADT/MesinKarKat/mesin_kata.c -o $(TARGET)
clean:
	rm *.o $(TARGET)